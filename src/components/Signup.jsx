    ...
    return (
        <section className="h-screen flex justify-center items-center bg-black text-white">
            <div className="bg-gray-800 p-8 rounded-lg shadow-lg max-w-sm w-full">
                ...
                <input type="text" placeholder="Full Name" className="block w-full p-3 mb-4 rounded bg-black border border-gray-700 text-white" />
                ...
                <button className="w-full bg-blue-600 hover:bg-blue-700 px-4 py-3 rounded">Sign Up</button>
            </div>
        </section>
    );
}